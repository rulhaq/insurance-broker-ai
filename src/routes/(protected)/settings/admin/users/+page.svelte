...
<svelte:head>
  <title>User Management - Admin Settings</title>
</svelte:head>
          ...
          <div class="bg-white shadow rounded-lg mb-6">
            <div class="px-6 py-4">
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
                ...
                <div>
                  <label for="roleFilter" class="block text-sm font-medium text-neutral-700">
                    Role
                  </label>
                  <select
                    id="roleFilter"
      ...
      <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form on:submit|preventDefault={handleUpdateUser} class="px-6 py-4 space-y-6">
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
              <label for="department" class="block text-sm font-medium text-neutral-700">
                Department
              </label>
              <input
                type="text"
