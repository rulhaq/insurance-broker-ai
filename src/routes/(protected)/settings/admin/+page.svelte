...
<svelte:head>
  <title>Admin Settings - Insurance Broker Pro</title>
</svelte:head>
            ...
            <div class="flex-1 min-w-0">
              <nav class="flex" aria-label="Breadcrumb">
                <ol role="list" class="flex items-center space-x-4">
                  <li>
                    <div>
                      <a href="/settings" class="text-neutral-400 hover:text-neutral-500">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <span class="ml-4 text-sm font-medium text-neutral-500">Admin Settings</span>
                    </div>
                  </li>
                </ol>
              </nav>
