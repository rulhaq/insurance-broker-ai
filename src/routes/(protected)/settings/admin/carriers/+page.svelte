...
<svelte:head>
  <title>Insurance Carriers - Admin Settings</title>
</svelte:head>
      ...
      <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form on:submit|preventDefault={handleSubmit} class="px-6 py-4 space-y-6">
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
              <label for="code" class="block text-sm font-medium text-neutral-700">
                Carrier Code *
              </label>
              <input
                type="text"
            ...
            <div>
              <label for="rating" class="block text-sm font-medium text-neutral-700">
                Financial Rating
              </label>
              <select
                id="rating"
          ...
          <!-- Address -->
          <div>
            <h4 class="text-sm font-medium text-neutral-900 mb-3">Address</h4>
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                <label for="zipCode" class="block text-sm font-medium text-neutral-700">
                  ZIP Code
                </label>
                <input
                  type="text"
              ...
              {#each specialtyOptions as specialty}
                <label class="relative flex items-start">
                  ...
                  <div class="ml-3 text-sm">
                    <span class="font-medium text-neutral-700">{specialty}</span>
                  </div>
                </label>
              {/each}
            </div>
