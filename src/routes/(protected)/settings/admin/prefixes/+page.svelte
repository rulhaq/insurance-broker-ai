...
<svelte:head>
  <title>Quote & Policy Prefixes - Admin Settings</title>
</svelte:head>
          ...
          <form on:submit|preventDefault={saveSettings} class="space-y-8">
            ...
            <div class="bg-white shadow rounded-lg">
              ...
              <div class="px-6 py-6 space-y-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                  <div>
                    <label for="quotePrefix" class="block text-sm font-medium text-neutral-700">
                      Prefix
                    </label>
                    <input
                      type="text"
                      id="quotePrefix"
                      bind:value={settings.quotePrefix}
                  ...
                  <div>
                    <label for="quoteSeparator" class="block text-sm font-medium text-neutral-700">
                      Separator
                    </label>
                    <select
                      id="quoteSeparator"
                      bind:value={settings.quoteSeparator}
                      class="mt-1 block w-full border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                    >
                  ...
                  <div>
                    <label for="quoteStartNumber" class="block text-sm font-medium text-neutral-700">
                      Start Number (Sequential)
                    </label>
                    <input
                      type="number"
                      id="quoteStartNumber"
                      bind:value={settings.quoteStartNumber}
                      min="1"
                      class="mt-1 block w-full border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                    />
                  </div>
                    ...
                    {#each formatOptions as option}
                      <label class="relative flex items-start">
                        <div class="flex items-center h-5">
                          <input
                            type="radio"
                            bind:group={settings.quoteNumberFormat}
                            value={option.value}
            ...
            <div class="bg-white shadow rounded-lg">
              ...
              <div class="px-6 py-6 space-y-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                  <div>
                    <label for="policyPrefix" class="block text-sm font-medium text-neutral-700">
                      Prefix
                    </label>
                    <input
                      type="text"
                      id="policyPrefix"
                      bind:value={settings.policyPrefix}
                      class="mt-1 block w-full border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                      placeholder="POL"
                    />
                  </div>
                  ...
                  <div>
                    <label for="policySeparator" class="block text-sm font-medium text-neutral-700">
                      Separator
                    </label>
                    <select
                      id="policySeparator"
                      bind:value={settings.policySeparator}
                      class="mt-1 block w-full border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                    >
                      <option value="-">Dash (-)</option>
                      <option value="_">Underscore (_)</option>
                  ...
                  <div>
                    <label for="policyStartNumber" class="block text-sm font-medium text-neutral-700">
                      Start Number (Sequential)
                    </label>
                    <input
                      type="number"
                      id="policyStartNumber"
                      bind:value={settings.policyStartNumber}
                      min="1"
                      class="mt-1 block w-full border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                    />
                  </div>
                    ...
                    {#each formatOptions as option}
                      <label class="relative flex items-start">
                        <div class="flex items-center h-5">
                          <input
                            type="radio"
                            bind:group={settings.policyNumberFormat}
                            value={option.value}
                            class="focus:ring-primary-500 h-4 w-4 text-primary-600 border-neutral-300"
                          />
                        </div>
                ...
                <div class="space-y-4">
                  <label class="relative flex items-start">
                    <div class="flex items-center h-5">
                      <input
                        type="checkbox"
                        bind:checked={settings.includeYear}
                  ...
                  <label class="relative flex items-start">
                    <div class="flex items-center h-5">
                      <input
                        type="checkbox"
                        bind:checked={settings.includeBrokerCode}
                        class="focus:ring-primary-500 h-4 w-4 text-primary-600 border-neutral-300 rounded"
                      />
                    </div>
                    <div class="ml-3">
                  ...
                  {#if settings.includeBrokerCode}
                    <div class="ml-7">
                      <label for="brokerCodeLength" class="block text-sm font-medium text-neutral-700">
                        Broker Code Length
                      </label>
                      <select
                        id="brokerCodeLength"
                        bind:value={settings.brokerCodeLength}
                        class="mt-1 block w-32 border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                      >
