...
<svelte:head>
  <title>Client Management - Admin Settings</title>
</svelte:head>
      ...
      <div class="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form on:submit|preventDefault={handleSubmit} class="px-6 py-4 space-y-6">
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
            ...
            <div>
              <label for="clientType" class="block text-sm font-medium text-neutral-700">
                Client Type
              </label>
              <select
                id="clientType"
          ...
          {#if formData.clientType === 'business'}
            <div>
              <label for="businessName" class="block text-sm font-medium text-neutral-700">
                Business Name
              </label>
              <input
                type="text"
