...
<svelte:head>
  <title>User Activity - App Admin Area</title>
</svelte:head>
        ...
        <div class="py-6">
          <div class="lg:flex lg:items-center lg:justify-between">
            ...
            <div class="mt-5 flex lg:mt-0 lg:ml-4">
              <button type="button" on:click={loadActivityLogs} class="inline-flex items-center px-4 py-2 border border-neutral-300 rounded-md shadow-sm text-sm font-medium text-neutral-700 bg-white hover:bg-neutral-50">
            ...
            <div class="px-6 py-4">
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-5">
                <div>
                  ...
                  <input type="text" id="search" bind:value={searchTerm} placeholder="User, action, or details..." class="mt-1 block w-full border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" />
                </div>
                <div>
                  <label for="actionFilter" class="block text-sm font-medium text-neutral-700">Action</label>
                  <select id="actionFilter" bind:value={actionFilter} class="mt-1 block w-full border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                ...
                <div>
                  <label for="userRoleFilter" class="block text-sm font-medium text-neutral-700">User Role</label>
                  <select id="userRoleFilter" bind:value={userRoleFilter} class="mt-1 block w-full border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                ...
                <div>
                  <label for="dateFilter" class="block text-sm font-medium text-neutral-700">Time Range</label>
                  <select id="dateFilter" bind:value={dateFilter} class="mt-1 block w-full border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                ...
                <div class="flex items-end">
                  <span class="text-sm text-neutral-500">{filteredLogs.length} of {activityLogs.length} logs</span>
                </div>
              </div>
            </div>
          </div>
                      ...
                      <div class="flex items-center">
                        ...
                        <div class="ml-4">
                          <div class="flex items-center space-x-2">
                            ...
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {getRoleColor(log.userRole)}">{log.userRole}</span>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {getActionColor(log.action)}">{log.action}</span>
                          </div>
