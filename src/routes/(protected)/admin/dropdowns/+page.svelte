...
<svelte:head>
  <title>Dropdown Values - App Admin Area</title>
</svelte:head>
        ...
        <div class="py-6">
          <div class="lg:flex lg:items-center lg:justify-between">
            ...
            <div class="mt-5 flex lg:mt-0 lg:ml-4">
              <button type="button" on:click={saveDropdownValues} disabled={saving} class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 disabled:opacity-50">
              ...
              <div class="space-y-2">
                {#each dropdownValues.industries as industry, index}
                  <div class="flex items-center space-x-2">
                    <input type="text" bind:value={dropdownValues.industries[index]} class="flex-1 border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" />
                    <button on:click={() => removeItem('industries', index)} class="text-red-600 hover:text-red-900">Remove</button>
                  </div>
                {/each}
                <button on:click={() => addItem('industries')} class="text-primary-600 hover:text-primary-900 text-sm">+ Add Industry</button>
              </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg p-6">
              ...
              <div class="space-y-2">
                {#each dropdownValues.coverageLimits as limit, index}
                  <div class="flex items-center space-x-2">
                    <input type="number" bind:value={limit.value} class="w-32 border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" />
                    <input type="text" bind:value={limit.label} class="flex-1 border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" />
                    <button on:click={() => removeLimitItem('coverageLimits', index)} class="text-red-600 hover:text-red-900">Remove</button>
                  </div>
                {/each}
                <button on:click={() => addLimitItem('coverageLimits')} class="text-primary-600 hover:text-primary-900 text-sm">+ Add Limit</button>
              </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg p-6">
              ...
              <div class="space-y-2">
                {#each dropdownValues.countries as country, index}
                  <div class="flex items-center space-x-2">
                    <input type="text" bind:value={dropdownValues.countries[index]} class="flex-1 border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" />
                    <button on:click={() => removeItem('countries', index)} class="text-red-600 hover:text-red-900">Remove</button>
                  </div>
                {/each}
                <button on:click={() => addItem('countries')} class="text-primary-600 hover:text-primary-900 text-sm">+ Add Country</button>
              </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg p-6">
              ...
              <div class="space-y-2">
                {#each dropdownValues.deductibles as deductible, index}
                  <div class="flex items-center space-x-2">
                    <input type="number" bind:value={deductible.value} class="w-32 border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" />
                    <input type="text" bind:value={deductible.label} class="flex-1 border-neutral-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm" />
                    <button on:click={() => removeLimitItem('deductibles', index)} class="text-red-600 hover:text-red-900">Remove</button>
                  </div>
                {/each}
                <button on:click={() => addLimitItem('deductibles')} class="text-primary-600 hover:text-primary-900 text-sm">+ Add Deductible</button>
              </div>
            </div>
          </div>
        {/if}
